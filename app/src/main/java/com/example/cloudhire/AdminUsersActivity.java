...
public class AdminUsersActivity extends AppCompatActivity {
    ...
    private TextView tabCandidates;
    private TextView tabRecruiters;
    ...
    private void setupNavigation() {
        ...
        findViewById(R.id.navAdminHome)
        ...
        findViewById(R.id.navAdminUsers)
                .setOnClickListener(v -> {
                    // Already on Users screen
                });

        findViewById(R.id.navAdminJobs)
                .setOnClickListener(v -> {

                    startActivity(
                            new Intent(
                                    this,
                                    AdminJobsActivity.class
                            )
                    );
                });

        findViewById(R.id.navAdminApps)
                .setOnClickListener(v -> {

                    startActivity(
                            new Intent(
                                    this,
                                    AdminApplicationsActivity.class
                            )
                    );
                });

        findViewById(R.id.btnAdminUsersBack)
    ...
    private void updateTabUI() {
        ...
        if (selectedRole.equals("Candidate")) {
            ...
            tabCandidates.setBackgroundResource(
                    R.drawable.bg_filter_active
            );

            tabCandidates.setTextColor(
                    Color.WHITE
            );

            tabCandidates.setTypeface(
                    null,
                    android.graphics.Typeface.BOLD
            );

            tabRecruiters.setBackgroundResource(
                    R.drawable.bg_filter_inactive
            );

            tabRecruiters.setTextColor(
    ...
    private void setupSearch() {
        ...
        etUserSearch.addTextChangedListener(
                new TextWatcher() {
